// To parse this data:
//
//   import { Convert, StarshipList } from "./file";
//
//   const starshipList = Convert.toStarshipList(json);
//
...
export class Convert {
    public static toStarshipList(json: string): StarshipList {
        return cast(JSON.parse(json), r("StarshipList"));
    }

    public static starshipListToJson(value: StarshipList): string {
        return JSON.stringify(uncast(value, r("StarshipList")), null, 2);
    }
}
